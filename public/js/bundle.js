    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        ...
        case 2:
          ...
          return _context.a(2, (0, _alerts.showAlert)('error', data.message));
        case 3:
...
},{"./alerts":"alerts.js"}],"updateSetting.js":[function(require,module,exports) {
"use strict";
...
var updateSettings = exports.updateSettings = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(data, type) {
    var url, options, res, resdata, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
          url = type === "password" ? "/api/v1/users/updateMyPassword" : "/api/v1/users/updateMe"; // Prepare fetch options conditionally
          options = {
            method: "PATCH"
          };
          if (type === "data") {
        ...
        case 2:
          ...
          return _context.a(2, (0, _alerts.showAlert)("error", resdata.message));
        case 3:
        ...
        case 4:
          _context.p = 4;
          _t = _context.v;
          console.error('Update error:', _t); // Enhanced error logging
          (0, _alerts.showAlert)("error", "Something went wrong! Try again.");
        case 5:
          return _context.a(2);
      }
...
var bookTour = exports.bookTour = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(tourId) {
    var response, data, stripeSession, _t;
    return _regenerator().w(function (_context) {
      while (1) switch (_context.p = _context.n) {
        case 0:
          _context.p = 0;
        ...
        case 3:
          stripeSession = data.session; // <- this is the actual session object
        ...
        case 4:
          ...
          alert('Error booking tour: ' + _t.message);
        case 5:
          return _context.a(2);
      }
    }, _callee, null, [[0, 4]]);
...
if (userDataForm) {
  userDataForm.addEventListener('submit', function (e) {
    ...
    (0, _updateSetting.updateSettings)(formData, 'data');
  });
}
if (userPasswordForm) {
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.preventDefault();
  var button = e.currentTarget; // ensures you get the button itself
  console.log("tour book is clicked");
  button.textContent = 'Processing...';
  var tourId = button.dataset.tourId;
  if (!tourId) {
